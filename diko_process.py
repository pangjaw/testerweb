...
# CONFIG
# =============================================
SOURCE_FOLDER = r"\\10.1.37.114\DATA SINTEL BOGOR\Cloud Server Bogor\files\7.IMO\7. IMO 2026\2. PEMERIKSAAN\05. Mei"
OUTPUT_BASE   = r"\\10.1.37.114\DATA SINTEL BOGOR\Cloud Server Bogor\files\7.IMO\7. IMO 2026\2. PEMERIKSAAN\05. Mei\Hasil Proses"
...
def build_filename(prefix_periode, kode, jenis, identitas, tgl_full, format_bd):
    if format_bd:
        ...
        return f"{prefix_periode}_{kode}_{jenis}_{identitas}_{tgl_full}.pdf"
